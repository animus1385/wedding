<template>
    <section class="info">
        <div class="info__container container">
            <h2
                class="info__title title-level-2"
                data-aos="fade"
                data-aos-delay="500"
            ...
            <div class="info__descr-block">
                <p
                    class="info__descr text-1"
                    data-aos="fade"
                    data-aos-delay="700"
                    data-aos-duration="1000"
                    data-aos-easing="ease-in-out"
                    data-aos-once="true"
                >
                    Мы рады сообщить Вам, что состоится самое главное торжество в нашей совместной жизни - день нашей свадьбы!
                </p>
                <p
                    class="info__descr text-1"
                    data-aos="fade"
            ...
            <div class="info__date">
                <div class="info__date-mounth text-3" data-aos="fade-down" data-aos-once="true">Сентябрь</div>
